...
public class Video3 extends VideoGerado {

	private String nomeGerar;
	private String idVideoTemp;

	public Video3(String idUsuario, String nomeGerar) throws Exception {
		this.setIdVideo(2);
	...
	public void gerarVideo() throws Exception {
		...
		int posicao = getIdVideo().intValue();
		IMediaReader mediaReader = ToolFactory.makeReader(prop
				.getUrlVideosRespostas()[posicao]);
		...
		String urlTemp = folderBase +  idVideoTemp + "/"+"video3.mp4"; 
