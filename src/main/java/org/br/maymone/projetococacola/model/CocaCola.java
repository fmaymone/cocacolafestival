...
public class CocaCola {
	...
	public CocaCola(Calendar dataCriacao, String respostas, String urlVideo,
		...
		try {
			...
			URL url = new URL(
					"http://festivaldomeujeito.com.br/site/uploads/festival/"
							+ getJsonCoca().getUsuFaceId() + "/avatar_crop.png");
			// URL url = new
			// URL("http://festivaldomeujeito.com.br/site/uploads/festival/934089803315913/avatar_crop.png");
	...
	public String getPathVideos() {
		...
		try {
			...
			retorno = classLoader.getResource("temp/" + getNome() + "/")
					.getPath();
		...
		// URL in =
		// Thread.currentThread().getContextClassLoader().getResource("temp/" +
		// getNome() + "/");
