...
public class Video4 extends VideoGerado {
	...
	public Video4() throws Exception {
		super.setIdVideo(4);
		super.setgPosicoes(new GeradorPosicoes(4));
	...
	File file = new File(super.getUrlCena4());
	...
	String urlTemp = folder.getAbsolutePath() +  "\\"+ idUsuarioPasta + "/"+"video4.mov"; 
