...
public class CaptureScreenToFile
{
  ...
  public static void main(String[] args)
  {
    try
    {
      ...
      for (int index = 0; index < SECONDS_TO_RUN_FOR*FRAME_RATE.getDouble(); index++)
      {
        ...
        BufferedImage heisenberg = convertToType(img,
                BufferedImage.TYPE_3BYTE_BGR);
        ...
        writer.encodeVideo(1,heisenberg,
                System.nanoTime()-startTime, TimeUnit.NANOSECONDS);
      ...
      int targetType)
  {
    ...
    // otherwise create a new image of the target ty	pe and draw the new
    // image
