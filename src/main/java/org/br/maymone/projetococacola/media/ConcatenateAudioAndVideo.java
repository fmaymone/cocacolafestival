...
public class ConcatenateAudioAndVideo
{
  ...
  public static void main(String[] args)
  {
    ...
    File source1 = new File("E:\\M4V02107.mp4");
    File source2 = new File("E:\\M4V02107.mp4");
    File source3 = new File("E:\\Nando.mp4");
    ...
    try {
		concatenate(source1.getCanonicalPath(), source2.getCanonicalPath(), source3.getCanonicalPath());
	} catch (IOException e) {
		// 
		e.printStackTrace();
	}
