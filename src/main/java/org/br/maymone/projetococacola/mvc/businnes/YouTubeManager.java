...
import com.google.common.collect.Lists;
	...
	public class YouTubeManager {
		  ...
		  private static final File CREDENTIAL_STORE = new File(System.getProperty("user.home"),
			  ...
			  private static LocalServerReceiver localReceiver; 
			  ...
			  public YouTubeManager(){
				  ...
				  try {
					Integer port = new Integer(prop.getProp().getProperty("prop.port.youtube"));
					localReceiver = new LocalServerReceiver.Builder().setPort(port.intValue()).build();
				} catch (NumberFormatException | IOException e) {
					// TODO Auto-generated catch block
					Log.info("Erro ao criar o YoutubeManager", localReceiver);
				}
		  ...
		  private static Credential authorize(List<String> scopes) throws Exception {
		    ...
		    // Load client secrets.
			  ...
			  //Reader reader = new InputStreamReader(YoutubeManager.class.getResourceAsStream("client_secrets.json"));
	       ...
	       FileDataStoreFactory credentialStore = new FileDataStoreFactory(CREDENTIAL_STORE);
		    ...
		    //LocalServerReceiver localReceiver = new LocalServerReceiver.Builder().setPort(9091).build();
		  ...
		  public static void main(String[] args) {}
			  ...
			  public boolean publicarVideo(InputStream input){
				  // Scope required to upload to YouTube.
				    ...
				    try {
				      ...
				      InputStreamContent mediaContent = new InputStreamContent(
				          VIDEO_FILE_FORMAT,input);
				      
				      Long lenght = new Long(new Integer(input.available()).longValue());
				      
				      mediaContent.setLength(lenght);
