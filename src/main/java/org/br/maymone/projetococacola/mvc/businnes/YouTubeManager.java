...
public class YouTubeManager {
	...
	private static final File CREDENTIAL_STORE = new File(
			System.getProperty("user.home"), ".credentials/youtube.json");
	...
	public YouTubeManager() {
		...
		try {
			Integer port = new Integer(prop.getProp().getProperty(
					"prop.port.youtube"));
	...
	private static Credential authorize(List<String> scopes) throws Exception {
		...
		// Reader reader = new
		// InputStreamReader(YoutubeManager.class.getResourceAsStream("client_secrets.json"));
		 ...
		 * ".credentials/youtube-api-updatevideo.json"), JSON_FACTORY);
		 */
	...
	private static File[] getLocalVideoFiles() throws IOException {
		...
		System.out.println("Video files from "
	...
	public String publicarVideo(InputStream input, CocaCola c) {
		...
		try {
			...
			urlVideo = returnedVideo.getId().toString();
